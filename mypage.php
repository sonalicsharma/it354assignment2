...
<?php elseif ($str_language == 'en'): ?>
    ...
    <p class="text"><strong>Oh My God!!!! The virtual host was set up successfully.</strong></p>
    <p class="text">If Sonali can see this page, your new virtual host was set up successfully. Now, web content can be added and this placeholder page<sup><a href="#footnote_1">1</a></sup> should be replaced or deleted.</p>
    <p class="text">
        Server name: <samp><?php echo $_SERVER['SERVER_NAME']; ?></samp><br />
        Document root: <samp><?php echo $_SERVER['DOCUMENT_ROOT']; ?></samp>
    </p>
